...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        $sql = "SELECT ad, soyad, IBAN, banka FROM Kullanicilar WHERE kullanici_id = ?";
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="kullanici_update.php" method="POST">
                                            <div class="mb-3">
                                                <label for="ad" class="form-label">Ad</label>
                                                <input type="text" class="form-control" id="ad" name="ad" value="<?= htmlspecialchars($ad) ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="soyad" class="form-label">Soyad</label>
                                                <input type="text" class="form-control" id="soyad" name="soyad" value="<?= htmlspecialchars($soyad) ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="IBAN" class="form-label">IBAN</label>
                                                <input type="text" class="form-control" id="IBAN" name="IBAN" value="<?= htmlspecialchars($IBAN) ?>" 
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="banka" name="banka" value="<?= htmlspecialchars($banka) ?>" required>
                                            </div>
